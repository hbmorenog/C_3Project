...
database_hotel={
    1: HotelInDB(id=1,mail="decameron@gmail.com",
                    password="123abc",
                    ubication="Cartagena",
                    name="Decameron",
                    price=250000),
    2: HotelInDB(id=2,mail="hilton@gmail.com",
                    password="root",
                    ubication="Santa Marta",
                    name="Hilton",
                    price=300000),
    3: HotelInDB(id=3,mail="calypso@gmail.com",
                    password="admin123",
...
def get_Hotel_id(id):
    if id in database_hotel:
        return database_hotel[id]
    else:
        return None
